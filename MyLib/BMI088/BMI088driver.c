...
*               len - Ҫ��ȡ���ֽ���
* @retval:     	void
* @details:    	ͨ��BMI088���ٶȼƵ�SPI����������ȡ����Ĵ����ĺ�?��
************************************************************************
**/
...
* @param:       void
* @retval:     	uint8_t - �������?
* @details:    	BMI088���ٶȴ�������ʼ������������ͨ�ż��?������λ�����üĴ���д�뼰���?
************************************************************************
**/
...
* @param:       void
* @retval:     	uint8_t - �������?
* @details:    	BMI088�����Ǵ�������ʼ������������ͨ�ż��?������λ�����üĴ���д�뼰���?
************************************************************************
**/
...
* @param:       gyro - ���������� (���ٶ�, x, y, z) ��λ: rad/s
* @param:       accel - ���ٶȼ����� (���Լ��ٶ�, x, y, z) ��λ: m/s?
* @param:       temperate - �¶�ָ��
* @retval:     	void
* @details:    	��ȡBMI088�������ǡ����ٶȼƺ��¶�����
************************************************************************
**/
